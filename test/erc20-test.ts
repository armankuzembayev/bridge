...
describe("ERC20", function ()  {
    ...
    beforeEach(async function() {
        ...
        const name = Configs.nameErc20Eth;
        const symbol = Configs.symbolErc20Eth;
    ...
    describe("Deployment", function() {
        ...
        it("Should initialize correctly", async function() {
            expect(await hardhatToken.name()).to.equal(Configs.nameErc20Eth);
            expect(await hardhatToken.symbol()).to.equal(Configs.symbolErc20Eth);
